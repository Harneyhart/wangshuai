...
import {Col, Row, Space, message, Popconfirm, Button, List, Tabs, Modal, Form, Input, Select, Table, Tag, Divider, Upload, Card, Popover, Spin, Typography, Pagination, Descriptions, TimePicker } from 'antd';
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{
                    ...
                    <button
                        style={{
                            border: 'none',
                            background: activeTab === 'homework' ? '#fff' : '#f7f8fa',
                            borderBottom: activeTab === 'homework' ? '2px solid #1890ff' : '2px solid transparent',
                            color: activeTab === 'homework' ? '#1890ff' : '#666',
                            fontWeight: activeTab === 'homework' ? 'bold' : 'normal',
                            padding: '8px 24px',
                            outline: 'none',
                            cursor: 'pointer'
                        }}
                    ...
                    <button
                        style={{
                            border: 'none',
                            background: activeTab === 'turnhomework' ? '#fff' : '#f7f8fa',
                            borderBottom: activeTab === 'turnhomework' ? '2px solid #1890ff' : '2px solid transparent',
                            color: activeTab === 'turnhomework' ? '#1890ff' : '#666',
                            fontWeight: activeTab === 'turnhomework' ? 'bold' : 'normal',
                            padding: '8px 24px',
                            outline: 'none',
                            cursor: 'pointer'
                        }}
                        onClick={() => setActiveTab('turnhomework')}
                    >
                        作业批改
                    </button>
                    <button
                        ...
                        <Form form={editForm} layout="vertical">
                            ...
                            >
                                <Select placeholder="请选择上课班级" showSearch optionFilterProp="children">
                                    {classes.map(cls => (
                                        <Select.Option key={cls.id} value={cls.name}>{cls.name}</Select.Option>
                                    ))}
                                </Select>
                            </Form.Item>
                            <Form.Item
