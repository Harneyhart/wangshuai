      ...
      <div className="overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            ...
            <div className="mt-14 flex justify-end gap-8 sm:mt-0 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
  ...
  return (
    <div className="">
      ...
      <footer className="mx-auto max-w-7xl overflow-hidden px-6 pb-20 sm:pb-24 lg:px-8">
        <p className="mt-0 text-center text-base font-bold leading-5 text-gray-500">
          白磊（武汉大学）和薛亮（北京生智）联合开发{' '}
        </p>
      </footer>
    </div>
  );
